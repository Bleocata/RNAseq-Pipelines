...
export ADAPTERS_FILE="/home/scratch90/bleocata_20240912/PRJEB37100/Adapters_sequences.fa" #CUIDADO: Arquivo de adaptadores para o Trimmomatic
export THREADS=5
export JOBS=4
...
mkdir -p "${WD}/sra/" "${WD}/fastq/" "${WD}/result_fastqc/" "${WD}/result_multiqc/" "${WD}/Results_trimming_MM/" "${WD}/result_fastqc_post_trimming/" "${WD}/result_multiqc_post_trimming/" "${ref_GRCh38}" "${WD}/STAR_alignment/genomeSTAR/" "${WD}/stats_reports2/" "${WD}/coverage_reports2/" "${BAM_DIR}"
